...
interface LoginFormProps {
  authenticate: (prev: string | undefined, formData: FormData) => Promise<string | undefined>;
  googleAction: () => Promise<void>;
  githubAction: () => Promise<void>;
}

export function LoginForm({ authenticate, googleAction, githubAction }: LoginFormProps) {
    ...
    <Card className="border-primary/10 shadow-lg">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <form action={githubAction} className="w-full">
            <Button type="submit" variant="outline" className="w-full" disabled={isPending}>
