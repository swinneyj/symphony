...
export const videoProviderEnum = pgEnum("video_provider", ["sora", "seedance", "kling", "kling_v1", "kling_v3", "openai_tts", "elevenlabs", "kokoro"]);
...
export const videoFormulas = pgTable("video_formulas", {
  ...
  /** Per-line overlay positions [{x,y}] fractions (0..1), aligned with the
   * newline-separated overlay_template lines. null = legacy stacked-top. */
  overlayLayout: jsonb("overlay_layout"),
